...
int main() {
    ...
    vector<Vertex> transformed_vertices = transform_vertices(vertices, alpha, beta, gamma, 0, 0, 3);
    ...
    lodepng::encode("poly_8.png", image, W, H, LCT_RGB, 8);
