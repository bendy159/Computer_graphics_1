...
int main() {
    ...
    string filename = "objects/Borderlands.obj";
    ...
    vector<Vertex> transformed_vertices = transform_vertices(vertices, alpha, beta, gamma, 0, 0, 100000);
    ...
    vector<unsigned char> texture = load_texture("textures/Borderlands.png", texWidth, texHeight);

    draw_triangle(image, z_buffer, W, H, transformed_vertices, faces, texCoords, texture, texWidth, texHeight, a_X, a_Y, u_0, v_0);

    lodepng::encode("poly_14.png", image, W, H, LCT_RGB, 8);
